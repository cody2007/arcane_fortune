...
//////////////////////////////////////////////
// From: rust-sdl2/sdl2-sys/sdl_bindings.rs
// Credit to the Rust-SDL2 contributors
...
pub type SDL_malloc_func =
    ::core::option::Option<unsafe extern "C" fn(size: size_t) -> *mut c_void>;
pub type SDL_calloc_func =
    ::core::option::Option<unsafe extern "C" fn(nmemb: size_t, size: size_t) -> *mut c_void>;
pub type SDL_realloc_func = ::core::option::Option<
    unsafe extern "C" fn(mem: *mut c_void, size: size_t) -> *mut c_void,
>;
pub type SDL_free_func = ::core::option::Option<unsafe extern "C" fn(mem: *mut c_void)>;
extern "C" {
...
extern "C" {
    pub fn SDL_strlcpy(dst: *mut c_char, src: *const c_char, maxlen: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn SDL_strlcat(dst: *mut c_char, src: *const c_char, maxlen: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    ...
    pub fn SDL_SetAssertionHandler(handler: SDL_AssertionHandler, userdata: *mut c_void);
}
extern "C" {
...
extern "C" {
    ...
    pub fn SDL_GetAssertionHandler(puserdata: *mut *mut c_void) -> SDL_AssertionHandler;
}
extern "C" {
...
pub type SDL_ThreadFunction =
    ::core::option::Option<unsafe extern "C" fn(data: *mut c_void) -> c_int>;
extern "C" {
...
pub struct SDL_RWops {
    ...
    pub close: ::core::option::Option<unsafe extern "C" fn(context: *mut SDL_RWops) -> c_int>,
    pub type_: Uint32,
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  \\return the final offset in the data stream, or -1 on error."]
    pub fn SDL_RWseek(context: *mut SDL_RWops, offset: Sint64, whence: c_int) -> Sint64;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  \\return the data, or NULL if there was an error."]
    pub fn SDL_LoadFile(file: *const c_char, datasize: *mut size_t) -> *mut c_void;
}
extern "C" {
...
extern "C" {
    ...
    pub fn SDL_MixAudio(dst: *mut Uint8, src: *const Uint8, len: Uint32, volume: c_int);
}
extern "C" {
...
extern "C" {
    ...
    #[doc = "  \\sa SDL_GetQueuedAudioSize"]
    #[doc = "  \\sa SDL_ClearQueuedAudio"]
    pub fn SDL_DequeueAudio(dev: SDL_AudioDeviceID, data: *mut c_void, len: Uint32)
        -> Uint32;
}
extern "C" {
...
pub type __m64 = [c_longlong; 1usize];
pub type __v1di = [c_longlong; 1usize];
pub type __v2si = [c_int; 2usize];
pub type __v4hi = [c_short; 4usize];
pub type __v8qi = [c_char; 8usize];
pub type __v4si = [c_int; 4usize];
pub type __v4sf = [f32; 4usize];
pub type __m128 = [f32; 4usize];
pub type __m128_u = [f32; 4usize];
pub type __v4su = [c_uint; 4usize];
...
extern "C" {
    pub fn malloc(__size: c_ulong) -> *mut c_void;
}
extern "C" {
    pub fn calloc(__nmemb: c_ulong, __size: c_ulong) -> *mut c_void;
}
extern "C" {
    pub fn realloc(__ptr: *mut c_void, __size: c_ulong) -> *mut c_void;
}
extern "C" {
    pub fn reallocarray(
        __ptr: *mut c_void,
...
extern "C" {
    pub fn alloca(__size: c_ulong) -> *mut c_void;
}
extern "C" {
...
extern "C" {
    pub fn atexit(__func: ::core::option::Option<unsafe extern "C" fn()>) -> c_int;
}
extern "C" {
    pub fn at_quick_exit(__func: ::core::option::Option<unsafe extern "C" fn()>) -> c_int;
}
extern "C" {
    pub fn on_exit(
...
extern "C" {
    pub fn gcvt(__value: f64, __ndigit: c_int, __buf: *mut c_char)
        -> *mut c_char;
}
/*extern "C" {
    pub fn qecvt(
...
extern "C" {
    pub fn mbtowc(__pwc: *mut wchar_t, __s: *const c_char, __n: size_t) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn _mm_getcsr() -> c_uint;
}
extern "C" {
    pub fn _mm_setcsr(__i: c_uint);
}
pub type __m128d = [f64; 2usize];
pub type __m128i = [c_longlong; 2usize];
pub type __m128d_u = [f64; 2usize];
pub type __m128i_u = [c_longlong; 2usize];
pub type __v2df = [f64; 2usize];
pub type __v2di = [c_longlong; 2usize];
pub type __v8hi = [c_short; 8usize];
pub type __v16qi = [c_char; 16usize];
pub type __v2du = [c_ulonglong; 2usize];
pub type __v8hu = [c_ushort; 8usize];
pub type __v16qu = [c_uchar; 16usize];
pub type __v16qs = [c_schar; 16usize];
extern "C" {
    pub fn _mm_clflush(__p: *const c_void);
}
extern "C" {
    pub fn _mm_lfence();
}
...
extern "C" {
    ...
    pub fn SDL_GetSurfaceAlphaMod(surface: *mut SDL_Surface, alpha: *mut Uint8) -> c_int;
}
extern "C" {
...
//////////////////////// note I changed the repr from u32 to u8
///// so it can be used in the SDL_WindowEvent structure
///// I don't know if anything was assuming this was u32...
#[repr(u8)]
...
extern "C" {
    ...
    pub fn SDL_LogSetOutputFunction(callback: SDL_LogOutputFunction, userdata: *mut c_void);
}
#[repr(u32)]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "\\return 0 on success, or -1 on error."]
    pub fn SDL_LinuxSetThreadPriority(threadID: Sint64, priority: c_int) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn _Xmblen(str: *mut c_char, len: c_int) -> c_int;
}
...
pub struct _XExtData {
    ...
    pub free_private:
        ::core::option::Option<unsafe extern "C" fn(extension: *mut _XExtData) -> c_int>,
...
pub struct _XImage_funcs {
    ...
    >,
    pub destroy_image:
        ::core::option::Option<unsafe extern "C" fn(arg1: *mut _XImage) -> c_int>,
    ...
    pub add_pixel: ::core::option::Option<
        unsafe extern "C" fn(arg1: *mut _XImage, arg2: c_long) -> c_int,
    >,
}
#[test]
...
pub struct XKeyboardState {
    ...
    pub auto_repeats: [c_char; 32usize],
}
#[test]
...
pub struct _bindgen_ty_8 {
    ...
    pub private15:
        ::core::option::Option<unsafe extern "C" fn(arg1: *mut _XDisplay) -> c_int>,
...
pub type XICProc = ::core::option::Option<
    unsafe extern "C" fn(arg1: XIC, arg2: XPointer, arg3: XPointer) -> c_int,
>;
...
extern "C" {
    pub fn XLoadQueryFont(arg1: *mut Display, arg2: *const c_char) -> *mut XFontStruct;
}
extern "C" {
...
extern "C" {
    pub fn XFetchBytes(arg1: *mut Display, arg2: *mut c_int) -> *mut c_char;
}
extern "C" {
    pub fn XFetchBuffer(
        arg1: *mut Display,
...
extern "C" {
    pub fn XGetAtomName(arg1: *mut Display, arg2: Atom) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XDisplayName(arg1: *const c_char) -> *mut c_char;
}
extern "C" {
    pub fn XKeysymToString(arg1: KeySym) -> *mut c_char;
}
extern "C" {
    pub fn XSynchronize(
        arg1: *mut Display,
        ...
        unsafe extern "C" fn(arg1: *mut Display, arg2: c_int) -> c_int,
    >;
}
extern "C" {
    pub fn XSetAfterFunction(
        arg1: *mut Display,
        arg2: ::core::option::Option<unsafe extern "C" fn(arg1: *mut Display) -> c_int>,
    ) -> ::core::option::Option<
        unsafe extern "C" fn(
            arg1: *mut Display,
            arg2: ::core::option::Option<unsafe extern "C" fn(arg1: *mut Display) -> c_int>,
...
extern "C" {
    pub fn XLoadFont(arg1: *mut Display, arg2: *const c_char) -> Font;
}
extern "C" {
    pub fn XCreateGC(
        arg1: *mut Display,
...
extern "C" {
    pub fn XGetFontPath(arg1: *mut Display, arg2: *mut c_int) -> *mut *mut c_char;
}
extern "C" {
    pub fn XListExtensions(arg1: *mut Display, arg2: *mut c_int) -> *mut *mut c_char;
}
extern "C" {
    pub fn XListProperties(arg1: *mut Display, arg2: Window, arg3: *mut c_int) -> *mut Atom;
}
extern "C" {
    pub fn XListHosts(
        arg1: *mut Display,
...
extern "C" {
    pub fn XKeycodeToKeysym(arg1: *mut Display, arg2: KeyCode, arg3: c_int) -> KeySym;
}
extern "C" {
...
extern "C" {
    pub fn XStringToKeysym(arg1: *const c_char) -> KeySym;
}
extern "C" {
...
extern "C" {
    pub fn XScreenResourceString(arg1: *mut Screen) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XInitExtension(arg1: *mut Display, arg2: *const c_char) -> *mut XExtCodes;
}
extern "C" {
    pub fn XAddExtension(arg1: *mut Display) -> *mut XExtCodes;
}
extern "C" {
    pub fn XFindOnExtensionList(arg1: *mut *mut XExtData, arg2: c_int) -> *mut XExtData;
}
extern "C" {
...
extern "C" {
    pub fn XServerVendor(arg1: *mut Display) -> *mut c_char;
}
extern "C" {
    pub fn XDisplayString(arg1: *mut Display) -> *mut c_char;
}
extern "C" {
...
pub type XErrorHandler = ::core::option::Option<
    unsafe extern "C" fn(arg1: *mut Display, arg2: *mut XErrorEvent) -> c_int,
>;
extern "C" {
    pub fn XSetErrorHandler(arg1: XErrorHandler) -> XErrorHandler;
}
pub type XIOErrorHandler =
    ::core::option::Option<unsafe extern "C" fn(arg1: *mut Display) -> c_int>;
extern "C" {
...
extern "C" {
    pub fn XWithdrawWindow(arg1: *mut Display, arg2: Window, arg3: c_int) -> c_int;
}
extern "C" {
    pub fn XGetCommand(
        arg1: *mut Display,
...
extern "C" {
    pub fn XSetTransientForHint(arg1: *mut Display, arg2: Window, arg3: Window) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XAddToExtensionList(arg1: *mut *mut _XExtData, arg2: *mut XExtData) -> c_int;
}
extern "C" {
    pub fn XAddToSaveSet(arg1: *mut Display, arg2: Window) -> c_int;
}
extern "C" {
    pub fn XAllocColor(arg1: *mut Display, arg2: Colormap, arg3: *mut XColor) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XChangeSaveSet(arg1: *mut Display, arg2: Window, arg3: c_int) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XCirculateSubwindowsDown(arg1: *mut Display, arg2: Window) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XCopyGC(arg1: *mut Display, arg2: GC, arg3: c_ulong, arg4: GC) -> c_int;
}
extern "C" {
    pub fn XCopyPlane(
        arg1: *mut Display,
...
extern "C" {
    pub fn XDeleteProperty(arg1: *mut Display, arg2: Window, arg3: Atom) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XFreeExtensionList(arg1: *mut *mut c_char) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XFreeFontNames(arg1: *mut *mut c_char) -> c_int;
}
extern "C" {
    pub fn XFreeFontPath(arg1: *mut *mut c_char) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XGetKeyboardControl(arg1: *mut Display, arg2: *mut XKeyboardState) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XMaskEvent(arg1: *mut Display, arg2: c_long, arg3: *mut XEvent) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XQueryColor(arg1: *mut Display, arg2: Colormap, arg3: *mut XColor) -> c_int;
}
extern "C" {
    pub fn XQueryColors(
        arg1: *mut Display,
...
extern "C" {
    pub fn XQueryKeymap(arg1: *mut Display, arg2: *mut c_char) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XSelectInput(arg1: *mut Display, arg2: Window, arg3: c_long) -> c_int;
}
extern "C" {
    pub fn XSendEvent(
        arg1: *mut Display,
...
extern "C" {
    pub fn XSetBackground(arg1: *mut Display, arg2: GC, arg3: c_ulong) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XSetForeground(arg1: *mut Display, arg2: GC, arg3: c_ulong) -> c_int;
}
extern "C" {
    pub fn XSetFunction(arg1: *mut Display, arg2: GC, arg3: c_int) -> c_int;
}
extern "C" {
    pub fn XSetGraphicsExposures(arg1: *mut Display, arg2: GC, arg3: c_int) -> c_int;
}
extern "C" {
    pub fn XSetIconName(arg1: *mut Display, arg2: Window, arg3: *const c_char)
        -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XSetModifierMapping(arg1: *mut Display, arg2: *mut XModifierKeymap) -> c_int;
}
extern "C" {
    pub fn XSetPlaneMask(arg1: *mut Display, arg2: GC, arg3: c_ulong) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XSetSubwindowMode(arg1: *mut Display, arg2: GC, arg3: c_int) -> c_int;
}
extern "C" {
    pub fn XSetTSOrigin(
        arg1: *mut Display,
...
extern "C" {
    pub fn XSetWindowBorder(arg1: *mut Display, arg2: Window, arg3: c_ulong) -> c_int;
}
extern "C" {
    pub fn XSetWindowBorderPixmap(arg1: *mut Display, arg2: Window, arg3: Pixmap) -> c_int;
}
extern "C" {
...
extern "C" {
    pub fn XSetWindowColormap(arg1: *mut Display, arg2: Window, arg3: Colormap) -> c_int;
}
extern "C" {
    pub fn XStoreBuffer(
        arg1: *mut Display,
...
extern "C" {
    pub fn XStoreColor(arg1: *mut Display, arg2: Colormap, arg3: *mut XColor) -> c_int;
}
extern "C" {
    pub fn XStoreColors(
        arg1: *mut Display,
...
extern "C" {
    pub fn XSetLocaleModifiers(arg1: *const c_char) -> *mut c_char;
}
extern "C" {
    pub fn XOpenOM(
        arg1: *mut Display,
...
extern "C" {
    pub fn XSetOMValues(arg1: XOM, ...) -> *mut c_char;
}
extern "C" {
    pub fn XGetOMValues(arg1: XOM, ...) -> *mut c_char;
}
extern "C" {
    pub fn XDisplayOfOM(arg1: XOM) -> *mut Display;
}
extern "C" {
    pub fn XLocaleOfOM(arg1: XOM) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XSetOCValues(arg1: XOC, ...) -> *mut c_char;
}
extern "C" {
    pub fn XGetOCValues(arg1: XOC, ...) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XBaseFontNameListOfFontSet(arg1: XFontSet) -> *mut c_char;
}
extern "C" {
    pub fn XLocaleOfFontSet(arg1: XFontSet) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XSetIMValues(arg1: XIM, ...) -> *mut c_char;
}
extern "C" {
    pub fn XDisplayOfIM(arg1: XIM) -> *mut Display;
}
extern "C" {
    pub fn XLocaleOfIM(arg1: XIM) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn XmbResetIC(arg1: XIC) -> *mut c_char;
}
extern "C" {
    pub fn Xutf8ResetIC(arg1: XIC) -> *mut c_char;
}
extern "C" {
...
extern "C" {
    pub fn _Xmbtowc(arg1: *mut wchar_t, arg2: *mut c_char, arg3: c_int) -> c_int;
}
extern "C" {
    pub fn _Xwctomb(arg1: *mut c_char, arg2: wchar_t) -> c_int;
}
extern "C" {
    pub fn XGetEventData(arg1: *mut Display, arg2: *mut XGenericEventCookie) -> c_int;
}
extern "C" {
