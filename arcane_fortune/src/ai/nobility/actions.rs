...
const REQ_RESOURCE_FROM_PARENT_PROB_PER_TURN: f32 = 1./(19. * TURNS_PER_YEAR as f32);
const REQ_WAR_PEACE_FROM_PARENT_PROB_PER_TURN: f32 = 1./(19. * TURNS_PER_YEAR as f32);
const REQ_BLDG_FROM_PARENT_PROB_PER_TURN: f32 = 1./(19. * TURNS_PER_YEAR as f32);

const INDEPENDENCE_DECLARATION_PROB_PER_TURN: f32 = 1./(8. * TURNS_PER_YEAR as f32);
